...
public class PaymentManageController {
    ...
    public R addPaymentManage(String paymentManageStr) {
        JSONArray array = JSONUtil.parseArray(paymentManageStr);  //将实体类转换成json字符串
        List<PaymentManage> paymentManageList = JSONUtil.toList(array, PaymentManage.class); //将JSON对象数组转换为传入类型的List
