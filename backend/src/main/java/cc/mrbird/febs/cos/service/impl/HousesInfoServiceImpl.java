...
public class HousesInfoServiceImpl extends ServiceImpl<HousesInfoMapper, HousesInfo> implements IHousesInfoService {
    ...
    public LinkedHashMap<String, Object> home(Integer type) {
        if (type == null) {
            ...
            result.put("unpaid", payableRate != null && payableRate.get("unpaid") != null ? payableRate.get("unpaid").toString() : 0);
            result.put("electricity", payableRate != null && payableRate.get("electricity") != null ? payableRate.get("electricity").toString() : 0);
